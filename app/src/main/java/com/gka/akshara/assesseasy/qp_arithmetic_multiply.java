...
public class qp_arithmetic_multiply extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qp_arithmetic_multiply);
        ...
        ConstraintLayout clayout = (ConstraintLayout) findViewById(R.id.ConstraintLayout_parent_arithmeticmultiply);
        ...
        if(answer_editable != null) {
            ...
            if(answer.equals("")) {
                if (MainActivity.debugalerts)
                    Log.d("EASYASSESS", "qp_arithmetic_multiply: clickedNext: answer is empty string");
            ...
            if (MainActivity.debugalerts)
                Log.d("EASYASSESS", "qp_arithmetic_multiply: clickedNext: answer_editable is null");
            if(globalvault.allowskipquestions)
                this.invokeAssessmentManagerActivity();
            else
                return;
    ...
    public void invokeAssessmentManagerActivity() {
        ...
        if (MainActivity.debugalerts)
            Log.d("EASYASSESS", "qp_arithmetic_multiply: clickedNext: fromactivity: "+fromactivityname+" questionid:"+questionid);

...
public class qp_arithmetic_subtract extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qp_arithmetic_subtract);
        ...
        ConstraintLayout clayout = (ConstraintLayout) findViewById(R.id.ConstraintLayout_parent_arithmeticsubtract);
        ...
        if(answer_editable != null) {
            ...
            if(answer.equals("")) {
                if (MainActivity.debugalerts)
                    Log.d("EASYASSESS", "qp_arithmetic_subtract: clickedNext: answer is empty string");
                ...
                try {
                    ...
                    Log.e("EASYASSESS", "qp_qrithmetic_subtract: clickedNext: Exception: "+e.toString());
                }
            ...
            if (MainActivity.debugalerts)
                Log.d("EASYASSESS", "qp_arithmetic_subtract: clickedNext: answer_editable is null");
            if(globalvault.allowskipquestions) {
                globalvault.questions[questionid - 1].setPass("S");
                this.invokeAssessmentManagerActivity();
            }
    ...
    public void invokeAssessmentManagerActivity() {
        ...
        if (MainActivity.debugalerts)
            Log.d("EASYASSESS", "qp_arithmetic_subtract: clickedNext: answer: fromactivity: "+fromactivityname+" questionid:"+questionid);

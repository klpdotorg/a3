...
public class qp_truefalse_text extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qp_truefalse_text);
        ...
        ConstraintLayout clayout = (ConstraintLayout) findViewById(R.id.ConstraintLayout_parent_truefalse_text);
        ...
        try {
            ...
            Log.e("EASYASSESS", "qp_truefalse_text: exception: "+e.getMessage());
        }
        ...
        if(!TextUtils.isEmpty(answer)) {
            if (MainActivity.debugalerts)
                Log.d("EASYASSESS", "qp_truefalse_text: setting the answer.");
    ...
    public void clickedNext(View view) {
        ...
        if(selectedRadioButtonId == -1) { // Nothing selected
            if (MainActivity.debugalerts)
                Log.d("EASYASSESS", "qp_truefalse_text: clickedNext: No option selected");
        ...
        try {
            ...
            Log.e("EASYASSESS", "qp_truefalse_text: clickedNext: Exception:CorrectAnswer is null"+e.toString());
            globalvault.questions[questionid - 1].setPass("F");
        }
        this.invokeAssessmentManagerActivity();
    ...
    public void invokeAssessmentManagerActivity() {
        ...
        if (MainActivity.debugalerts)
            Log.d("EASYASSESS", "qp_truefalse_text: clickedNext: fromactivity: "+fromactivityname+" questionid:"+questionid);

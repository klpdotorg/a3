    ...
    public class deviceDatastoreMgr {
        ...
        public void initializeDS(android.content.Context context) {
            ...
            try {
                ...
                String a3appdbfilepath = path + "/"+a3dbname;

                if(MainActivity.debugalerts)
                    Log.d("EASYASSESS","a3dbfilepath: "+a3appdbfilepath);

                a3appdb = SQLiteDatabase.openOrCreateDatabase(a3appdbfilepath, null, null);
        ...
        public boolean createTables() {
            ...
            String query_createquestionsettbl = "CREATE TABLE IF NOT EXISTS a3app_questionset_tbl ( \n" +
                    ...
                    "subject_name text,  grade_name text, assesstype_name text)";
            ...
            String query_createquestiontbl = "CREATE TABLE IF NOT EXISTS a3app_question_tbl ( \n" +
                    ...
                    "questiontempltype_name text, assesstype_name text, concept_name text, mconcept_name txt)";
        ...
        public void saveAssessmentDetail(String[] arrData) {
            ...
            String query = "INSERT INTO a3app_assessment_tbl (id_assessment, id_question, answer_given, pass) \n"+
                    " VALUES (?,?,?,?)";
